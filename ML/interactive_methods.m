...
%}
    ...
    im_postprocess = struct( ...
        ...
        'dBs_local', ...
            InteractiveMethod(@dBs_local, {'local floor', 'local ceiling'}, {15, 60}), ...
        'dBs_global', ...
            InteractiveMethod(@dBs_global, {'global floor', 'global ceiling', 'global range'}, {15, 60, [0 2^32]}), ...
        'none', ...
            InteractiveMethod(@none)...
    );

    im = struct( ...
        'slice', InteractiveMethodSelector('slice method', im_slice, 'blur_slice'), ...
        'postprocess', InteractiveMethodSelector('postprocess method', im_postprocess, 'dBs_global') ...
    );
